...
namespace ChatApp.Utilities
{
    public static class ChatMessageLabelGenerator
    {
        ...
        {
            var labelForName = new Label { Text = friendChattingWith.FriendName + ":", FontSize = NAME_LABEL_FONT_SIZE, FontAttributes = FontAttributes.Bold, TextColor = Color.FromHex("#6082B6") };
            var labelForChatMsg = new Label { Text = chatMessage.Msg, TextColor = Color.Black };
            ...
            StackLayout stackLayoutForChatMessage = new StackLayout
            {
                ...
                Children =
                {
                    new Frame
                    {
                        ...
                        BackgroundColor = Color.FromHex("#E5E4E2"),
                        CornerRadius = 5.0f,
                    ...
                    new Frame
                    {
                        ...
                        Content = new Label{Text = "Written on: " + chatMessage.Date, FontSize = 8.0, TextColor = Color.Black}
                    },
                }
            };
        ...
        {
            var labelForName = new Label { Text = "You:", FontSize = NAME_LABEL_FONT_SIZE, FontAttributes = FontAttributes.Bold, TextColor = Color.Black };
            var labelForChatMsg = new Label { Text = chatMessage.Msg, TextColor = Color.Black };
            ...
            StackLayout stackLayoutForChatMessage = new StackLayout
            {
                ...
                Children =
                {
                    ...
                    {
                        Margin = new Thickness(3, 3, 3, 1),
                        BackgroundColor = Color.FromHex("#c5e3fe"),
                        CornerRadius = 5.0f,
                        Padding = new Thickness(10),
                        Content =
                        new StackLayout
                    ...
                    new StackLayout
                    {
                        ...
                        Children =
                        {
                            new Frame
                            {
                                ...
                                CornerRadius = 3.0f,
                                Padding = new Thickness(5),
                                Content = new Label{Text = "Msg sent", FontSize = 8.0, TextColor = Color.Black}
                            },
                            ...
                            new Frame
                            {
                                ...
                                Content = new Label{Text = msgSeenStatus, FontSize = 8.0, TextColor = Color.Black}
                            },
